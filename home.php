<?php
    ...
    $sql = "SELECT * FROM `project` WHERE `EmployerID`='$ID' AND `Status`='open'";
...
<html lang="en">
  <head>
        ...
        <title>Logistica - PES - Home</title>
  ...
  <body>
    ...
    <div class="list-group2">
        ...
        <?php
            ...
            {
                echo "<a href='#' class='list-group-item'><span class='glyphicon glyphicon-tasks' aria-hidden='true'></span>&nbsp;&nbsp;&nbsp;" . $row['Name'] . "<p class='alignright'>" . $row['DueDate'] . "</p></a>";
        ...
        <?php
            ...
            {
                echo '<div class="alert alert-success" role="alert">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="alert-link" href="createProject.php">ADD NEW PROJECT</div></a>
                ';
            }
            ?>
        </div>
