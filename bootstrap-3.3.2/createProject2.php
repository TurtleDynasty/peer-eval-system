<?php
    ...
    $ID = $_SESSION['ID'];
        ...
        $sql = "INSERT INTO project (ID, Name, DueDate, EmployerID, Status) VALUES ('', '$projectName', '$dueDate', '$ID', 'open')";
    ...
    <div class="navbar-wrapper">
      ...
      if($validFlag == TRUE)
      {
          echo '
            ...
            <div class="alert alert-info" role="alert"><p align="center">PROJECT CREATED</p></div>
            </div>
            </div>';
      }
      else{
