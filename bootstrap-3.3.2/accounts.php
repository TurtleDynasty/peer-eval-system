...
<html lang="en">
  <head>
        ...
        <title>Logistica - PES - All accounts</title>
  ...
  <body>
    <div class="navbar-wrapper">
      ...
      <!-- CONTENT -->
        ...
        <div class="alert alert-info" role="alert"><span class='glyphicon glyphicon-user' aria-hidden='true'></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Open Projects<p class="alignright"> Due date</p></div>
        <?php
            while($row = mysql_fetch_array($result))
            {
                echo "<a href='#' class='list-group-item'><span class='glyphicon glyphicon-user' aria-hidden='true'></span>&nbsp;&nbsp;&nbsp;" . $row['Name'] . "</a>";
